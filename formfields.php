...
return array(
  'enabled' => array(
    ...
    'fastway_methods' => array(
        ...
        'css' => 'width: 450px;',
        'default' => '',
        'options' => array('FWLred' => "Red Label",
  ...
  'type' => 'price',  'css' => 'width: 50px;color: green;', 'description' => __('Leave at 0.00 for Standard rates, else enter your custom rates', 'woocommerce-ozpost'),
      ...
      'hx_methods' => array(
        ...
        'type' => 'multiselect', 'description' => __('Using the placeholder values will enable a demo account (Not suitable for a live store)', 'woocommerce-ozpost'),
        'class' => 'wc-enhanced-select',
        'css' => 'width: 450px;',
        'default' => '',
        'options' => array('HXRF' => "Road Freight", 'HXAF' => "Air Freight"),
        'custom_attributes' => array(
            'data-placeholder' => __('Select Methods', 'woocommerce-ozpost')
        )),
     'hx_user' => array(
    ...
    'hx_fuellevy' => array(
        'title' => __('Hunter Express Fuel levy (percent)', 'woocommerce-ozpost'), 
         'description' => __('Hunter Express charge a fuel levy that is not included in their quotes. Apparently the amount charged is customer specific and based on a percentage of the GST inclusive shipping cost. Please enter your rate here', 'woocommerce-ozpost'), 
         'desc_tip' => true,
        'type' => 'price', 'css' => 'width: 50px;color: blue;', 'description' => __('', 'woocommerce-ozpost'),
        'placeholder' => wc_format_localized_price(0),
        'default' => '0.00'
   ...
   'hp_weight' => array(
    ...
    'default_weight' => array(
        ...
        'description' => __('Used if individual products don\'t have their own weight assigned. Use the same weight unit that you have set in the WooCommerce->Products-Weight Unit.', 'woocommerce-ozpost'),
        'default' => '',
        'desc_tip' => false,
    ...
    'default_dimensions' => array(
        ...
        'type' => 'input',
        'description' => __('These dimensions are used for products with no dimensions defined (format: L,W,H). Use the same dimension unit that you have set in the WooCommerce->Products-Dimensions Unit. The example/defaults assume CM', 'woocommerce-ozpost'),
        'default' => '29,24,2.5', 'css' => 'width: 120px;',
        'desc_tip' => false,
    ...
    'mail_days' => array(
        ...
        'type' => 'multiselect',
         'description' => __('This is used to provide best delivery date estimates. Enabling for SUN is the same as 1st opening of next business day. (Consider the situation of posting prepaid envelopes/satchels into local mailbox, to be cleared next business day)', 'woocommerce-ozpost'),
        'class' => 'wc-enhanced-select',
    ...
    'deadline' => array(
        ...
        'type' => 'checkbox', 'label' => ' tick to show carrier names', 
        'default' => 'yes',
    ),
